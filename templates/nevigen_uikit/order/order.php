...
<div class="jshop uk-panel uk-panel-box">
...
<div class="uk-grid uk-grid-divider">
  <div class="uk-width-1-4">
	<div><span class="uk-text-bold"><?php print _JSHOP_ORDER_NUMBER ?>:</span> <?php print $order->order_number ?></div>
	  <?php print $order->_tmp_ext_order_number;?>
    </div>
  <div class="uk-width-1-4">
	<div><span class="uk-text-bold"><?php print _JSHOP_ORDER_STATUS ?>:</span> <?php print $order->status_name ?> </div>
	<?php print $order->_tmp_ext_status_name;?>
    </div>
  <div class="uk-width-1-4">
      <span class="uk-text-bold"><?php print _JSHOP_ORDER_DATE ?>:</span> <?php print formatdate($order->order_date, 0) ?>
    </div>
  <div class="uk-width-1-4">
     <span class="uk-text-bold"><?php print _JSHOP_PRICE_TOTAL ?>:</span> <?php print formatprice($order->order_total, $order->currency_code); ?>
    </div>
</div>
<hr class="uk-margin-top-remove"/>

    <div class="uk-grid userinfo">
        <div class="uk-width-1-2 userbillinfo">
            <table class="jshop uk-table">
                <tr>
        ...
        <div class="uk-width-1-2 userdeliveryinfo">
        <?php if ($this->count_filed_delivery >0) {?>
            <table class="jshop uk-table userdeliveryinfo">
                <tr>
    ...
    <?php if ($this->allow_cancel){?>
        <div class="button_cancel">
            <a href="<?php print SEFLink('index.php?option=com_jshopping&controller=user&task=cancelorder&order_id='.$order->order_id)?>" class="uk-button">
